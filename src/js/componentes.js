...
const nombreElemento = event.target.localName ; // impt, label, button
...
ulFiltros.addEventListener ( 'click', ( event ) => {
	...
	//console.log( event.target.text ); esto permite saber el nombre del elemento al que se la da click
